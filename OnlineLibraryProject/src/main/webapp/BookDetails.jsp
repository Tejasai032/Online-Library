...
<div class="category">
           ...
           <div class="card" style="width: 16rem;">
                  <img src="https://i.pinimg.com/564x/b7/2e/fe/b72efecc138a6d32f44231b875714a18.jpg" class="card-img-top" alt="war of lanka">
                   <div class="card-body">
                  <p class="card-text"><b>BOOK-ID:</b> Book103A </p>
                  <p class="card-text"><b>TITLE:</b> War of lanka </p>
                  <p class="card-text"><b>ISBN:</b> 9356291527 </p>
                  <p class="card-text"><b>GENRE:</b> Fiction </p>
                  <p class="card-text"><b>PUBLICATON-YEAR:</b> 2019 </p>
                  <p class="card-text"><b>AUTHOR-ID:</b> Admin103 </p>
                  <form action="LibraryMember.jsp" >
                  <button>BORROW</button>
                  </form>
                   </div>
            ...
            <div class="card" style="width: 16rem;">
                  <img src="https://i.pinimg.com/564x/26/98/89/2698894a3b98f1a02b3a5c7bfc84fdca.jpg" class="card-img-top" alt="sitha">
                   <div class="card-body">
                  <p class="card-text"><b>BOOK-ID:</b> Book103B </p>
                  <p class="card-text"><b>TITLE:</b> Sita  </p>
                  <p class="card-text"><b>ISBN:</b> 9781721375974 </p>
                  <p class="card-text"><b>GENRE:</b> Fiction </p>
                  <p class="card-text"><b>PUBLICATON-YEAR:</b> 2017 </p>
                  <p class="card-text"><b>AUTHOR-ID:</b> Admin103 </p>
                  <form action="LibraryMember.jsp" >
                  <button>BORROW</button>
                  </form>
            ...
            <div class="card" style="width: 16rem;">
                  <img src="https://i.pinimg.com/564x/15/0d/c8/150dc82526eb0fa8c443842287a1580f.jpg" class="card-img-top" alt="vayuputras">
                   <div class="card-body">
                  <p class="card-text"><b>BOOK-ID:</b> Book103C </p>
                  <p class="card-text"><b>TITLE:</b> The oath of the vayuputras </p>
                  <p class="card-text"><b>ISBN:</b> 9789356290686 </p>
                  <p class="card-text"><b>GENRE:</b> Fiction </p>
                  <p class="card-text"><b>PUBLICATON-YEAR:</b> 2022 </p>
                  <p class="card-text"><b>AUTHOR-ID:</b> Admin103 </p>
                  <form action="LibraryMember.jsp" >
                  <button>BORROW</button>
                  </form>
            ...
            <div class="card" style="width: 16rem;">
                  <img src="https://i.pinimg.com/564x/fb/3b/f0/fb3bf07ef116b4d0ac169cba5497d036.jpg" class="card-img-top" alt="ravana">
                   <div class="card-body">
                  <p class="card-text"><b>BOOK-ID:</b> Book103D </p>
                  <p class="card-text"><b>TITLE:</b> Raavan </p>
                  <p class="card-text"><b>ISBN:</b> 97893388754088 </p>
                  <p class="card-text"><b>GENRE:</b> Fiction </p>
                  <p class="card-text"><b>PUBLICATON-YEAR:</b> 2019 </p>
                  <p class="card-text"><b>AUTHOR-ID:</b> Admin103 </p>
                  <form action="LibraryMember.jsp" >
...
<div class="category">
           ...
           <div class="card" style="width: 16rem;">
                  <img src="https://i.pinimg.com/564x/75/db/11/75db11148a9dbdfeb1b7ace03141d0b4.jpg" class="card-img-top" alt="iit jee">
                   <div class="card-body">
                  <p class="card-text"><b>BOOK-ID:</b> Book106A </p>
                  <p class="card-text"><b>TITLE:</b> IIT JEE Physics </p>
                  <p class="card-text"><b>ISBN:</b>  </p>
                  <p class="card-text"><b>GENRE:</b> Physics textbook </p>
                  <p class="card-text"><b>PUBLICATON-YEAR:</b> 20108 </p>
                  <p class="card-text"><b>AUTHOR-ID:</b> Admin106 </p>
                  <form action="LibraryMember.jsp" >
                  <button>BORROW</button>
                  </form>
                   </div>
            ...
            <div class="card" style="width: 16rem;">
                  <img src="https://i.pinimg.com/736x/6c/f3/18/6cf318213d07203950d5a3cc5aae4023.jpg" class="card-img-top" alt="quantum phy">
                   <div class="card-body">
                  <p class="card-text"><b>BOOK-ID:</b> Book106B </p>
                  <p class="card-text"><b>TITLE:</b> Quantum Physics </p>
                  <p class="card-text"><b>ISBN:</b> 9788192571409 </p>
                  <p class="card-text"><b>GENRE:</b> Physics textbook </p>
                  <p class="card-text"><b>PUBLICATON-YEAR:</b> 2012 </p>
                  <p class="card-text"><b>AUTHOR-ID:</b> Admin106 </p>
                  <form action="LibraryMember.jsp" >
                  <button>BORROW</button>
                  </form>
            ...
            <div class="card" style="width: 16rem;">
                  <img src="https://i.pinimg.com/564x/b1/f9/46/b1f946a8f38cd2c079e454501dd0bb2e.jpg" class="card-img-top" alt="concept of phy">
                   <div class="card-body">
                  <p class="card-text"><b>BOOK-ID:</b> Book106C </p>
                  <p class="card-text"><b>TITLE:</b> Concepts of Physics </p>
                  <p class="card-text"><b>ISBN:</b> 9788177091892 </p>
                  <p class="card-text"><b>GENRE:</b> Physics textbook </p>
                  <p class="card-text"><b>PUBLICATON-YEAR:</b> 2024 </p>
                  <p class="card-text"><b>AUTHOR-ID:</b> Admin106 </p>
                  <form action="LibraryMember.jsp" >
            ...
            <div class="card" style="width: 16rem;">
                  <img src="https://i.pinimg.com/564x/a8/2d/41/a82d41432d2eb10f797eb340fee3d2e4.jpg" class="card-img-top" alt="foundation of science">
                   <div class="card-body">
                  <p class="card-text"><b>BOOK-ID:</b> Book106D </p>
                  <p class="card-text"><b>TITLE:</b> Foundation of physics </p>
                  <p class="card-text"><b>ISBN:</b> 9788177097313 </p>
                  <p class="card-text"><b>GENRE:</b> Physics textbook </p>
                  <p class="card-text"><b>PUBLICATON-YEAR:</b> 2024 </p>
                  <p class="card-text"><b>AUTHOR-ID:</b> Admin106 </p>
                  <form action="LibraryMember.jsp" >
...
<div class="category">
           ...
           <div class="card" style="width: 16rem;">
                  <img src="https://i.pinimg.com/564x/c3/b4/fc/c3b4fcef2eb8b7e9f75c7a329122c2d2.jpg" class="card-img-top" alt="harrypoter(azkaban)">
                   <div class="card-body">
                  <p class="card-text"><b>BOOK-ID:</b>Book105A</p>
                  <p class="card-text"><b>TITLE:</b> H.P and the Prisoner of Azkaban </p>
                  <p class="card-text"><b>ISBN:</b> 9781408855676 </p>
                  <p class="card-text"><b>GENRE:</b> Juvenile Fiction </p>
                  <p class="card-text"><b>PUBLICATON-YEAR:</b> 2014 </p>
                  <p class="card-text"><b>AUTHOR-ID:</b> Admin105 </p>
                  <form action="LibraryMember.jsp" >
                  <button>BORROW</button>
                  </form>
                   </div>
            ...
            <div class="card" style="width: 16rem;">
                  <img src="https://i.pinimg.com/564x/fb/7e/66/fb7e66f8f41122f654d26911d6570049.jpg" class="card-img-top" alt="harrypoter(chamber of secrets)">
                   <div class="card-body">
                  <p class="card-text"><b>BOOK-ID:</b> Book105B </p>
                  <p class="card-text"><b>TITLE:</b> H.P and the Chamber of Secrets </p>
                  <p class="card-text"><b>ISBN:</b> 9781408855669 </p>
                  <p class="card-text"><b>GENRE:</b> Juvenile Fiction </p>
                  <p class="card-text"><b>PUBLICATON-YEAR:</b> 2014 </p>
                  <p class="card-text"><b>AUTHOR-ID:</b> Admin105 </p>
                  <form action="LibraryMember.jsp" >
            ...
            <div class="card" style="width: 16rem;">
                  <img src="https://i.pinimg.com/564x/c3/c0/89/c3c08954b7c42666ab9acf8e66990528.jpg" class="card-img-top" alt="harrypoter(order of the phoenix)">
                   <div class="card-body">
                  <p class="card-text"><b>BOOK-ID:</b> Book105C </p>
                  <p class="card-text"><b>TITLE:</b> H.P and the Order of the Phoenix </p>
                  <p class="card-text"><b>ISBN:</b> 9781408855690 </p>
                  <p class="card-text"><b>GENRE:</b> Juvenile Fiction </p>
                  <p class="card-text"><b>PUBLICATON-YEAR:</b> 2014 </p>
                  <p class="card-text"><b>AUTHOR-ID:</b> Admin105 </p>
                  <form action="LibraryMember.jsp" >
            ...
            <div class="card" style="width: 16rem;">
                  <img src="https://i.pinimg.com/564x/60/35/5e/60355ec8affadc84a111f2be66e383fc.jpg" class="card-img-top" alt="harrypoter(goblet of fire)">
                   <div class="card-body">
                  <p class="card-text"><b>BOOK-ID:</b> Book105D </p>
                  <p class="card-text"><b>TITLE:</b> H.P and the Goblet of Fire </p>
                  <p class="card-text"><b>ISBN:</b> 9781408855683 </p>
                  <p class="card-text"><b>GENRE:</b> Juvenile Fiction </p>
                  <p class="card-text"><b>PUBLICATON-YEAR:</b> 2014 </p>
                  <p class="card-text"><b>AUTHOR-ID:</b> Admin105 </p>
                  <form action="LibraryMember.jsp" >
...
<div class="category">
           ...
           <div class="card" style="width: 16rem;">
                  <img src="https://i.pinimg.com/736x/4c/31/15/4c3115b02964bd23bdf2f1be7ff031b4.jpg" class="card-img-top" alt="stories for children">
                   <div class="card-body">
                  <p class="card-text"><b>BOOK-ID:</b> Book104A </p>
                  <p class="card-text"><b>TITLE:</b> Great Stories for Children </p>
                  <p class="card-text"><b>ISBN:</b> 9788129118929 </p>
                  <p class="card-text"><b>GENRE:</b> Fiction </p>
                  <p class="card-text"><b>PUBLICATON-YEAR:</b> 2011 </p>
                  <p class="card-text"><b>AUTHOR-ID:</b> Admin104 </p>
                  <form action="LibraryMember.jsp" >
                  <button>BORROW</button>
                  </form>
                   </div>
            ...
            <div class="card" style="width: 16rem;">
                  <img src="https://i.pinimg.com/564x/16/09/3a/16093adac5df4c280b19ce1888cb0c10.jpg" class="card-img-top" alt="train journey">
                   <div class="card-body">
                  <p class="card-text"><b>BOOK-ID:</b> Book104B </p>
                  <p class="card-text"><b>TITLE:</b> The Great Train Journey </p>
                  <p class="card-text"><b>ISBN:</b> 9789353041519 </p>
                  <p class="card-text"><b>GENRE:</b> Fiction </p>
                  <p class="card-text"><b>PUBLICATON-YEAR:</b> 2018 </p>
                  <p class="card-text"><b>AUTHOR-ID:</b> Admin104 </p>
                  <form action="LibraryMember.jsp" >
                  <button>BORROW</button>
                  </form>
            ...
            <div class="card" style="width: 16rem;">
                  <img src="https://i.pinimg.com/564x/40/17/c6/4017c673db575a51c82f2f09baa68af7.jpg" class="card-img-top" alt="rusty">
                   <div class="card-body">
                  <p class="card-text"><b>BOOK-ID:</b> Book104C </p>
                  <p class="card-text"><b>TITLE:</b> Rusty and the Magic Mountain </p>
                  <p class="card-text"><b>ISBN:</b> 9780143444428 </p>
                  <p class="card-text"><b>GENRE:</b> Fiction </p>
                  <p class="card-text"><b>PUBLICATON-YEAR:</b> 2018 </p>
                  <p class="card-text"><b>AUTHOR-ID:</b> Admin104 </p>
                  <form action="LibraryMember.jsp" >
            ...
            <div class="card" style="width: 16rem;">
                  <img src="https://i.pinimg.com/564x/9d/3f/ef/9d3fef0591a2b7d54cb6ab73ddd6bd51.jpg" class="card-img-top" alt="cricket for crocodile">
                   <div class="card-body">
                  <p class="card-text"><b>BOOK-ID:</b> Book104D </p>
                  <p class="card-text"><b>TITLE:</b> Cricket for the Crocodile </p>
                  <p class="card-text"><b>ISBN:</b> 9780143334033 </p>
                  <p class="card-text"><b>GENRE:</b> Fiction </p>
                  <p class="card-text"><b>PUBLICATON-YEAR:</b> 2016 </p>
                  <p class="card-text"><b>AUTHOR-ID:</b> Admin104 </p>
                  <form action="LibraryMember.jsp" >
                  <button>BORROW</button>
                  </form>
...
<div class="category">
           ...
           <div class="card" style="width: 16rem;">
                  <img src="https://i.pinimg.com/564x/2f/3a/2a/2f3a2a16fb46c0c6920b76f25345c73c.jpg" class="card-img-top" alt="seditious heart">
                   <div class="card-body">
                  <p class="card-text"><b>BOOK-ID:</b> Book108A </p>
                  <p class="card-text"><b>TITLE:</b> My Seditious Heart </p>
                  <p class="card-text"><b>ISBN:</b> 9780670092499 </p>
                  <p class="card-text"><b>GENRE:</b> Political Science </p>
                  <p class="card-text"><b>PUBLICATON-YEAR:</b> 2019 </p>
                  <p class="card-text"><b>AUTHOR-ID:</b> Admin108 </p>
                  <form action="LibraryMember.jsp" >
                  <button>BORROW</button>
                  </form>
                   </div>
            ...
            <div class="card" style="width: 16rem;">
                  <img src="https://i.pinimg.com/564x/15/b8/49/15b849addd1042ea675c17beb21c52bb.jpg " class="card-img-top" alt="god of small things">
                   <div class="card-body">
                  <p class="card-text"><b>BOOK-ID:</b> Book108B </p>
                  <p class="card-text"><b>TITLE:</b> God of Small Things </p>
                  <p class="card-text"><b>ISBN:</b> 9789794614020 </p>
                  <p class="card-text"><b>GENRE:</b> Fiction </p>
                  <p class="card-text"><b>PUBLICATON-YEAR:</b> 2002 </p>
                  <p class="card-text"><b>AUTHOR-ID:</b> Admin108 </p>
                  <form action="LibraryMember.jsp" >
                  <button>BORROW</button>
                  </form>
            ...
            <div class="card" style="width: 16rem;">
                  <img src="https://i.pinimg.com/564x/ea/e9/4e/eae94e2c68d3918373dd880889be4acf.jpg" class="card-img-top" alt="power politics">
                   <div class="card-body">
                  <p class="card-text"><b>BOOK-ID:</b> Book108C </p>
                  <p class="card-text"><b>TITLE:</b> Power Politics </p>
                  <p class="card-text"><b>ISBN:</b> 9780896086685 </p>
                  <p class="card-text"><b>GENRE:</b> Political Science </p>
                  <p class="card-text"><b>PUBLICATON-YEAR:</b> 2002 </p>
                  <p class="card-text"><b>AUTHOR-ID:</b> Admin108 </p>
                  <form action="LibraryMember.jsp" >
            ...
            <div class="card" style="width: 16rem;">
                  <img src="https://i.pinimg.com/564x/1d/3b/ba/1d3bbabdeaee4f67fe7b6e111da47f85.jpg" class="card-img-top" alt="azadi">
                   <div class="card-body">
                  <p class="card-text"><b>BOOK-ID:</b> Book108D </p>
                  <p class="card-text"><b>TITLE:</b> Azadi </p>
                  <p class="card-text"><b>ISBN:</b> 9780670094417 </p>
                  <p class="card-text"><b>GENRE:</b> Indian Literature </p>
                  <p class="card-text"><b>PUBLICATON-YEAR:</b> 2020 </p>
                  <p class="card-text"><b>AUTHOR-ID:</b> Admin108 </p>
                  <form action="LibraryMember.jsp" >
                  <button>BORROW</button>
                  </form>
...
<div class="category">
           ...
           <div class="card" style="width: 16rem;">
                  <img src="https://i.pinimg.com/564x/62/3f/8f/623f8fee7aedff33d854ae99590ed344.jpg" class="card-img-top" alt="2states">
                   <div class="card-body">
                  <p class="card-text"><b>BOOK-ID:</b> Book109A </p>
                  <p class="card-text"><b>TITLE:</b> 2 States </p>
                  <p class="card-text"><b>ISBN:</b> 9783636344441 </p>
                  <p class="card-text"><b>GENRE:</b> Novel </p>
                  <p class="card-text"><b>PUBLICATON-YEAR:</b> 2014 </p>
                  <p class="card-text"><b>AUTHOR-ID:</b> Admin109 </p>
                  <form action="LibraryMember.jsp" >
                  <button>BORROW</button>
                  </form>
                   </div>
            ...
            <div class="card" style="width: 16rem;">
                  <img src="https://i.pinimg.com/564x/b6/fe/fb/b6fefb00d8250da034e32bf7f976d19e.jpg" class="card-img-top" alt="half girlfriend">
                   <div class="card-body">
                  <p class="card-text"><b>BOOK-ID:</b> Book109B </p>
                  <p class="card-text"><b>TITLE:</b> Half Girlfriend </p>
                  <p class="card-text"><b>ISBN:</b> 9788129135728 </p>
                  <p class="card-text"><b>GENRE:</b> Novel </p>
                  <p class="card-text"><b>PUBLICATON-YEAR:</b> 2014 </p>
                  <p class="card-text"><b>AUTHOR-ID:</b> Admin109 </p>
                  <form action="LibraryMember.jsp" >
            ...
            <div class="card" style="width: 16rem;">
                  <img src="https://i.pinimg.com/564x/7d/b0/68/7db068e4390ef59fcd6014feaace06e2.jpg" class="card-img-top" alt="3mistakes of my life">
                   <div class="card-body">
                  <p class="card-text"><b>BOOK-ID:</b> Book109C </p>
                  <p class="card-text"><b>TITLE:</b> The 3 Mistakes of my Life </p>
                  <p class="card-text"><b>ISBN:</b> 9788129135513 </p>
                  <p class="card-text"><b>GENRE:</b> Novel </p>
                  <p class="card-text"><b>PUBLICATON-YEAR:</b> 2014 </p>
                  <p class="card-text"><b>AUTHOR-ID:</b> Admin109 </p>
                  <form action="LibraryMember.jsp" >
            ...
            <div class="card" style="width: 16rem;">
                  <img src="https://i.pinimg.com/564x/96/88/11/968811062ebb23853427c01490c8302a.jpg" class="card-img-top" alt="one indian girl">
                   <div class="card-body">
                  <p class="card-text"><b>BOOK-ID:</b> Book109D </p>
                  <p class="card-text"><b>TITLE:</b> One Indian Girl </p>
                  <p class="card-text"><b>ISBN:</b> 9788129142146 </p>
                  <p class="card-text"><b>GENRE:</b> Novel </p>
                  <p class="card-text"><b>PUBLICATON-YEAR:</b> 2016 </p>
                  <p class="card-text"><b>AUTHOR-ID:</b> Admin109 </p>
                  <form action="LibraryMember.jsp" >
...
<div class="category">
           ...
           <div class="card" style="width: 16rem;">
                  <img src="https://i.pinimg.com/564x/15/62/4c/15624c65a0f3810c52f93115d62b4480.jpg" class="card-img-top" alt="jungle book">
                   <div class="card-body">
                  <p class="card-text"><b>BOOK-ID:</b> Book110A </p>
                  <p class="card-text"><b>TITLE:</b> Jungle Book </p>
                  <p class="card-text"><b>ISBN:</b> 9788172344221 </p>
                  <p class="card-text"><b>GENRE:</b> Fiction </p>
                  <p class="card-text"><b>PUBLICATON-YEAR:</b> 2012 </p>
                  <p class="card-text"><b>AUTHOR-ID:</b> Admin110 </p>
                  <form action="LibraryMember.jsp" >
                  <button>BORROW</button>
                  </form>
                   </div>
            ...
            <div class="card" style="width: 16rem;">
                  <img src="https://i.pinimg.com/564x/01/c2/80/01c2805dbd84258712a4685913dee3da.jpg" class="card-img-top" alt="just so stories">
                   <div class="card-body">
                  <p class="card-text"><b>BOOK-ID:</b> Book110B </p>
                  <p class="card-text"><b>TITLE:</b> Just so Stories </p>
                  <p class="card-text"><b>ISBN:</b> 9781617206375 </p>
                  <p class="card-text"><b>GENRE:</b> Popular Classic </p>
                  <p class="card-text"><b>PUBLICATON-YEAR:</b> 2012 </p>
                  <p class="card-text"><b>AUTHOR-ID:</b> Admin110 </p>
                  <form action="LibraryMember.jsp" >
                  <button>BORROW</button>
            ...
            <div class="card" style="width: 16rem;">
                  <img src="https://i.pinimg.com/564x/f4/1d/88/f41d8833eafdabea316ddc5d5beaa02a.jpg" class="card-img-top" alt="captian couragues">
                   <div class="card-body">
                  <p class="card-text"><b>BOOK-ID:</b> Book110C </p>
                  <p class="card-text"><b>TITLE:</b> Captains Courageous </p>
                  <p class="card-text"><b>ISBN:</b> 9781905863358 </p>
                  <p class="card-text"><b>GENRE:</b> Juvenile Fiction </p>
                  <p class="card-text"><b>PUBLICATON-YEAR:</b> 2008 </p>
                  <p class="card-text"><b>AUTHOR-ID:</b> Admin110 </p>
                  <form action="LibraryMember.jsp" >
                  <button>BORROW</button>
                  </form>
            ...
            <div class="card" style="width: 16rem;">
                  <img src="https://i.pinimg.com/564x/e1/e6/18/e1e6182bc04fad176d3a6547732e8711.jpg" class="card-img-top" alt="kim">
                   <div class="card-body">
                  <p class="card-text"><b>BOOK-ID:</b> Book110D </p>
                  <p class="card-text"><b>TITLE:</b> Kim </p>
                  <p class="card-text"><b>ISBN:</b> 9789388144322 </p>
                  <p class="card-text"><b>GENRE:</b> Fiction </p>
                  <p class="card-text"><b>PUBLICATON-YEAR:</b> 2018 </p>
                  <p class="card-text"><b>AUTHOR-ID:</b> Admin110 </p>
                  <form action="LibraryMember.jsp" >
